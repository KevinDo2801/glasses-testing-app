...
// show list of glasses 
const showGlasses = () => {
    let divGlasses = getEle("vglassesList");

    // create object for each glasses
    ...
    divGlasses.innerHTML = glassesList.renderGlasses();
...
const showInfo = (glObject)=>{
    ...
    divAvatar.innerHTML = `
        <img src="${glObject.virtualImg}" alt="${glObject.brand}" id="glasses">
    `;
    ...
    divInfo.innerHTML = `
        ...
        <p class="card-text"> 
            ...
            <span class="text-success">${glObject.status}</span>
        </p>
        <p class="card-text"> 
            ${glObject.desc}
        </p>
